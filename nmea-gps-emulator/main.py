...
.................................................................................................
    ...
    def nmea_serial(self):
        ...
        serial_config = serial_config_input(args)
...
#        prog='Greeting Script',
        ...
        epilog='(c) 2021 luk-kop, modify 2025 Alexey Bogdan aka SrFatCat'
    )
    parser.add_argument('-p', '--port', help='Port for Serial emulator')
    parser.add_argument('-b', '--baudrate', type=int, help='Baudrate for Serial emulator')
    #parser.add_argument('-f', '--frenq', type=int, choices=[1,10], default=1, help='Baudrate for Serial emulator')
